...
export function prepare(){
  ...
  const exported=join(work,'export');run(join(exporter,'.lake/build/bin/prod-export'),['--module','PrismPM.Foundation.Browser.V1.WorkspaceCommand','--root','PrismPM.Foundation.Browser.V1.WorkspaceCommand.workspaceCommandBytes','--root','PrismPM.Foundation.Browser.V1.WorkspaceJournal.workspaceJournalBytes','--ir-module','BrowserWorkspaceCommand','--out',exported],exporter,{LEAN_PATH:join(lean,'.lake/build/lib/lean')});
