        ...
        [mode, input, output, licenses] if ["native", "wasm"].contains(&mode.as_str()) => {
            ...
            let package = if mode == "native" {
                generate_cargo_package(
                    &module,
                    &CargoPackageSpec {
                        name: "publication-admission-core-probe".into(),
                        version: "0.1.0".into(),
                        description: "Generated internal publication verification fixture".into(),
                ...
                generate_core_wasm_package(
                    &module,
                    &CoreWasmSpec {
                        crate_name: "publication-admission-wire-probe".into(),
                        entry: "publicationWireBytes".into(),
