...
test_case!(conformance_ct_11, "CT-11");
...
test_case!(conformance_st_14, "ST-14");
test_case!(conformance_st_15, "ST-15");
test_case!(conformance_st_16, "ST-16");
...
test_case!(conformance_au_01, "AU-01");
test_case!(conformance_au_02, "AU-02");
test_case!(conformance_au_03, "AU-03");
...
test_case!(conformance_sy_08, "SY-08");
test_case!(conformance_dk_01, "DK-01");
test_case!(conformance_dk_02, "DK-02");
test_case!(conformance_dk_03, "DK-03");
test_case!(conformance_dk_04, "DK-04");
test_case!(conformance_dk_05, "DK-05");
test_case!(conformance_dk_06, "DK-06");
test_case!(conformance_dk_07, "DK-07");
test_case!(conformance_dk_08, "DK-08");
test_case!(conformance_dk_09, "DK-09");
test_case!(conformance_dk_10, "DK-10");
test_case!(conformance_dk_11, "DK-11");
test_case!(conformance_dk_12, "DK-12");
test_case!(conformance_dk_13, "DK-13");
test_case!(conformance_dk_14, "DK-14");
...
test_case!(conformance_dk_19, "DK-19");
test_case!(conformance_dk_20, "DK-20");
test_case!(conformance_dk_21, "DK-21");
test_case!(conformance_dk_22, "DK-22");
test_case!(conformance_oc_01, "OC-01");
test_case!(conformance_oc_02, "OC-02");
test_case!(conformance_oc_03, "OC-03");
test_case!(conformance_oc_04, "OC-04");
...
test_case!(conformance_lc_04, "LC-04");
test_case!(conformance_lc_05, "LC-05");
test_case!(conformance_lc_06, "LC-06");
test_case!(conformance_dp_01, "DP-01");
test_case!(conformance_dp_02, "DP-02");
test_case!(conformance_dp_03, "DP-03");
test_case!(conformance_dp_04, "DP-04");
test_case!(conformance_dp_05, "DP-05");
test_case!(conformance_dp_06, "DP-06");
test_case!(conformance_op_01, "OP-01");
test_case!(conformance_op_02, "OP-02");
test_case!(conformance_op_03, "OP-03");
test_case!(conformance_op_04, "OP-04");
test_case!(conformance_op_05, "OP-05");
test_case!(conformance_op_06, "OP-06");
test_case!(conformance_sc_01, "SC-01");
test_case!(conformance_sc_02, "SC-02");
test_case!(conformance_sc_03, "SC-03");
test_case!(conformance_sc_04, "SC-04");
test_case!(conformance_sc_05, "SC-05");
test_case!(conformance_sc_06, "SC-06");
test_case!(conformance_tm_01, "TM-01");
test_case!(conformance_tm_02, "TM-02");
test_case!(conformance_tm_03, "TM-03");
test_case!(conformance_tm_04, "TM-04");
test_case!(conformance_tm_05, "TM-05");
test_case!(conformance_tm_06, "TM-06");
